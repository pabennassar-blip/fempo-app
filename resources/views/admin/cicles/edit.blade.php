...
<form method="POST" action="{{ route('admin.cicles.update', $cicle) }}" style="max-width: 600px;">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="abreviatura" id="abreviatura" value="{{ old('abreviatura', $cicle->abreviatura) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="familia" id="familia" value="{{ old('familia', $cicle->familia) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="grau" id="grau" value="{{ old('grau', $cicle->grau) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="nivell" id="nivell" value="{{ old('nivell', $cicle->nivell) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="text" name="estudi" id="estudi" value="{{ old('estudi', $cicle->estudi) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
